...
const GuestFlow4 = () => {
  ...
  return (
    <View style={styles.guestFlow4}>
      ...
      <View style={styles.guestFlow4Inner}>
        <View style={[styles.groupWrapper, styles.feature3Position]}>
          <View style={[styles.groupWrapper, styles.feature3Position]}>
            <Text style={[styles.feature3, styles.feature3Position]}>
              Feature 3
            </Text>
          </View>
        </View>
