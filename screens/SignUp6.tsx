  ...
  return (
    <View style={styles.signUp6}>
      ...
      <View style={styles.groupParent}>
        <View style={styles.codeResentToExample123gmaiParent}>
          <Text style={styles.codeResentToContainer}>
            <Text style={styles.codeResentToContainer1}>
              <Text style={styles.codeResentTo}>{`Code resent to `}</Text>
              <Text style={styles.signUpTypo}>example123@gmail.com</Text>
              <Text style={styles.codeResentTo}>{`. `}</Text>
            </Text>
          </Text>
          <Pressable
        ...
        >
          ...
          >
            <Text style={styles.codeResentTo}>{`A confirmation code was sent to
`}</Text>
            <Text style={styles.signUpTypo}>example123@gmail.com</Text>
            <Text style={styles.codeResentTo}>.</Text>
          </Text>
...
const styles = StyleSheet.create({
  ...
  codeResentToContainer1: {
    lineBreak: "anywhere",
    width: "100%",
  },
  codeResentToContainer: {
    height: 19,
    display: "flex",
    width: 269,
    fontSize: FontSize.buttonsButton_size,
  ...
  codeResentToExample123gmaiParent: {
    top: 233,
    left: 60,
    height: 44,
    width: 269,
